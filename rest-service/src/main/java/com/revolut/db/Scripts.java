...
public interface Scripts {
    ...
    public static final String DATA_ACC5 = "insert into account (acc_id,acc_owner_name,account_number,amount,account_type,acc_user_id) values (5, 'Natali Lafore',111111111111111127, 20000,'DOLLAR',31)";
